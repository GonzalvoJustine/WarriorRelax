 ...
 */
final class Version20211121125321 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE order_item CHANGE session_id session_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE order_item CHANGE session_id session_id INT NOT NULL');
    }
}
